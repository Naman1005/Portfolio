...
function App() {
  ...
  return (
    <div className={`${isDark ? 'bg-gradient-to-b from-[#030712] via-[#0f172a] to-[#020617]' : 'bg-gradient-to-b from-white via-gray-50 to-white'} min-h-[200vh] relative`}>
      {/* Decorative Elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-1/4 left-1/4 w-32 md:w-64 h-32 md:h-64 rounded-full blur-3xl animate-pulse ${isDark ? 'bg-pink-500/10' : 'bg-blue-500/10'}`} />
        <div className={`absolute top-1/3 right-1/4 w-48 md:w-96 h-48 md:h-96 rounded-full blur-3xl animate-pulse ${isDark ? 'bg-orange-500/10' : 'bg-indigo-500/10'}`} />
        <div className={`absolute bottom-1/4 left-1/3 w-40 md:w-80 h-40 md:h-80 rounded-full blur-3xl animate-pulse ${isDark ? 'bg-yellow-500/10' : 'bg-purple-500/10'}`} />
      ...
      <div className="name-container fixed top-0 left-0 w-full h-screen flex items-center justify-center">
        <div className="relative">
          <div className="text-center cursor-pointer" onClick={toggleTheme}>
            <h1
              className={`font-bold tracking-wider font-impact ${isDark ? 'text-orange-300' : 'text-blue-900'}`}
              style={{
            ...
            <h1
              className={`font-bold tracking-wider font-raleway ${isDark ? 'text-orange-300' : 'text-blue-900'}`}
              style={{
        ...
        <div className={`absolute bottom-8 w-full text-center text-xs md:text-sm tracking-widest animate-bounce ${isDark ? 'text-orange-400/30' : 'text-blue-900/30'}`}>
          SCROLL TO EXPLORE
        </div>
      </div>
      ...
      <div className="relative top-[100vh] w-full">
        <div className={`glass-effect ${isDark ? 'dark' : 'light'}`}>
          {/* Hero Section */}
          <section className="content-section">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h2 className="section-title">About Me</h2>
                <p className={`text-base md:text-lg leading-relaxed mb-6 md:mb-8 ${isDark ? 'text-orange-200/80' : 'text-gray-700'}`}>
          ...
          <section className="content-section">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                ...
                <p className={`text-base md:text-lg mb-6 md:mb-8 ${isDark ? 'text-orange-200/80' : 'text-gray-700'}`}>
